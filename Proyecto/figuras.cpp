...
void CFiguras::piso(float altura, float largo, float profundidad, GLuint front, GLuint right, GLuint back, GLuint left, GLuint bottom, GLuint top)  //Funcion creacion prisma
{
...
void CFiguras::prismaExterior(float altura, float largo, float profundidad, GLuint text, float x, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, x*1.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(x*1.0f, x*1.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(x*1.0f, 0.0f); glVertex3fv(vertice[1]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(x*1.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(x*1.0f, x*1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, x*1.0f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, x*1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(x*1.0f, x*1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(x*1.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(x*1.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(x*1.0f, x*1.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, x*1.0f); glVertex3fv(vertice[3]);
	glEnd();
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(x*1.0f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(x*1.0f, x*1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, x*1.0f); glVertex3fv(vertice[7]);
	glEnd();
}

void CFiguras::prisma_textura(float largo, float altura, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma_textura1(float largo, float altura, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::triang(float altura, float largo, float profundidad, GLuint text)  
{
...
void CFiguras::prisma(float altura, float largo, float profundidad, GLuint text, float x)  //Funcion creacion prisma
{
...
void CFiguras::media_esfera(GLfloat radio, int meridianos, int paralelos, GLuint text )
{
	GLdouble theta, phi;
...
void CFiguras::cilindro1(float radio, float altura, int resolucion, GLuint text,GLuint text2,GLuint text3)
{
