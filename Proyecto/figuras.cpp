...
void CFiguras::prisma (float altura, float largo, float profundidad, GLuint front, GLuint right, GLuint back, GLuint left, GLuint bottom, GLuint top)  //Funcion creacion prisma
{
